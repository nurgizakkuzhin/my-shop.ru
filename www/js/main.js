...
function addToCart(itemId){
    console.log("js - addToCart()"); //отрабатывает это функция(отладочная функция)
	/**
	 * данная функция из библиотеки JQuery, записываем параметр запроса, тип запроса метод POST
	 * async: не асинхронный
	 * url: обращение
	 *
	 */
	$.ajax({
